...
Like in Lab 6, the MZI HWP$_u$ in the upper arm is set to $45^\circ$
and the MZI/idler LP$_i$ is set to $90^\circ$.
The only changes are: 1. Set the pump HWP$_p$ to $45^\circ$ to generate entangled pairs;
