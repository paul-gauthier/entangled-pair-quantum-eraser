...
\caption*{
  ...
  Amplitudes are based on photon counts from 30-sec acquisitions.
}
\end{table*}

\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{data/2025-06-15-09-31-29--sigaligned-on_joint.pdf}
\caption*{
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{data/2025-06-15-09-31-29--sigaligned-off_joint.pdf}
\caption*{
...
\emph{Note: The y-axis scale is the same in all four graph panels.}
