...
Only horizontally polarized photons can travel the bottom arm
and pass the horizontal LP$_i$ filter.
Only vertically polarized photons can travel the top arm
and pass the horizontal LP$_i$ filter
-- they will encounter HWP$_t$ and assume H polarization.
Horizontally polarized photons entering the top arm will become V polarized
