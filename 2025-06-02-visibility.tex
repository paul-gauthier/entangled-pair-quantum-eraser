...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{coincidence_counts_eraser_on.pdf}
\caption{
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{coincidence_counts_eraser_off.pdf}
\caption{
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{coincidence_counts_signal_blocked.pdf}
\caption{
  Signal beam blocked
